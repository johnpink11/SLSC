...
Agent $\mathcal{B}$ maintains a persistent compressed state by processing $\mathcal{A}$'s response through three sequential sub-steps: extraction, optional formalization, and merging. Algorithm~\ref{alg:curation} summarizes the pipeline.
